...
public class SauceOnDemandAdminServlet extends AbstractSauceOnDemandServlet {
    ...
    protected void renderBody(HttpServletRequest request, StringBuilder builder) {
        ...
        builder.append("<div>");
                builder.append("<label for='").append(SELENIUM_HOST)
                        .append("'>Selenium Host </label> : <input type='text' name='")
                        .append(SELENIUM_HOST).append("' id='")
                        .append(SELENIUM_HOST).append("' value='")
                        .append(p.getSeleniumHost()).append("' />");
                builder.append("</div>");
    ...
    private void updateBrowsers(HttpServletRequest req,
        ...
        String seleniumHost = req.getParameter(SELENIUM_HOST);
        String seleniumPort = req.getParameter(SELENIUM_PORT);
        ...
        proxy.setSeleniumHost(seleniumHost);
        proxy.setSeleniumPort(seleniumPort);
